        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-2 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Sign Up or Log In</h4>
              <p className="text-gray-600 text-center">Start by creating your Audiosa account or log in with your existing Spotify credentials.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Explore Your Library</h4>
              <p className="text-gray-600 text-center">Access your saved music, playlists, and recent listening history.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">Explore recommendations, charts, and genres to uncover fresh tracks.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Create Playlists</h4>
              <p className="text-gray-600 text-center">Build your playlists by adding songs you love or discover new ones along the way.</p>
            </div>
