        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex-shrink-0 mr-4">
            ...
            <Link to="/" className="block" aria-label="Cruip">
              ...
              <h3 className='text-xl font-bold'>Audiosa</h3>
            </Link>
          ...
          <nav className="flex flex-grow">
            <ul className="flex gap-10 flex-grow justify-end flex-wrap items-center">
              <li>
              ...
              <li>
                <a href="#" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 ">Analytics</a>
              </li>
              <li>
